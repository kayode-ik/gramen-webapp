            ...
            <div className="swiper-wrapper">
              ...
              <div className="swiper-slide relative">
                ...
                >
                  ...
                  <div className="HeroRightBox mr-40 z-10">
                    <h1
                      className="text-base mb-4 font-normal tracking-wider"
                      style={{ color: "#F6F6F6" }}
                    >
                      From Material Take-off
                      <br /> production to Emergency <br />
                      Pipeline Repair, our expertise
                      <br /> spans the spectrum
                    </h1>
                    <Button
